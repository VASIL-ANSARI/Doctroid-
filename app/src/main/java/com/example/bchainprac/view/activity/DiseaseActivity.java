...
public class DiseaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        im[2]=findViewById(R.id.content_disease3);
        im[3]=findViewById(R.id.content_disease4);
        im[4]=findViewById(R.id.content_disease5);
        im[5]=findViewById(R.id.content_disease6);
        im[6]=findViewById(R.id.content_disease7);
