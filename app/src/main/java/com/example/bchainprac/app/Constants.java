package com.example.bchainprac.app;
...
public class Constants {
    ...
    public static String FIREBASE_URL="https://doctroid-app-default-rtdb.firebaseio.com/";
    ...
    public static final String PREF_NOT="notifications";
    public static final String HOSPITAL_FIRST_TIME_LOGIN="hospitalFirstTimeLogin";
