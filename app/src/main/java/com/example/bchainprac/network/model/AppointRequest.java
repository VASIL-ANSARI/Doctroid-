...
public class AppointRequest {
    ...
    public AppointRequest(String c_id, String t_id, String p_id, String req_status, String req_time, String req_date, String req_comment,String h_id,String status) {
        this.c_id = c_id;
        this.t_id = t_id;
        this.p_id = p_id;
        this.req_status = req_status;
